...
$sql = "SELECT * FROM timetable WHERE (monday = 'NIL' OR tuesday = 'NIL' OR wednesday = 'NIL' OR thursday = 'NIL' OR friday = 'NIL') AND (DATE(CONCAT('2023-', SUBSTR(time, 1, 2), '-', SUBSTR(time, 4, 2))) >= '$date')";
